...
from utils import post_request, get_request, to_query_str, printf, cookie_string, cookie_json, get_trace_id, hashed_id
...
class DeviceRegister:
    ...
    def send_passport_region(self, phone_or_mail: str):
        """
        ...
        body = f"hashed_id={hashed_id(phone_or_mail)}&type=1"
